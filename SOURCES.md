...
- English: James Legge, *The Yî King* (Sacred Books of the East XVI, 1882), Internet Archive scan — {{LEGGE_IA}}
...
- *Über Sinn und Bedeutung* (Zeitschrift für Philosophie und philosophische Kritik 100, 1892), complete: Deutsches Textarchiv transcription — {{DTA_SUB}}
...
- German text: Internet Archive/MDZ scan of the first edition (Bayerische Staatsbibliothek) — {{KAPP_IA}}; the MDZ digitization itself: {{KAPP_MDZ}}
- English: working translation made for this site (CC0).
...
- English: Lionel Giles, *Taoist Teachings from the Book of Lieh Tzŭ* (1912, PD), Internet Archive scan — {{GILES_IA}}
...
- Jacob Grimm, *Zeitung für Einsiedler* No. 7 (23 April 1808), col. 56: MDZ scan of the first printing — {{GRIMM_MDZ}}
